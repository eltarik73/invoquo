...
const PLANS = [
  { name: "Essentiel", price: "19", popular: false, features: [
    { t: "Reception Plateforme Agreee illimitee", ok: true },
    { t: "Dashboard et suivi des factures", ok: true },
    { t: "Notifications par email", ok: true },
    { t: "Export comptable basique", ok: true },
    { t: "Emission de factures via PA", ok: false },
    { t: "Creation de factures et devis", ok: false },
  ]},
  { name: "Standard", price: "39", popular: true, features: [
    { t: "Tout l'Essentiel", ok: true },
    { t: "Emission Plateforme Agreee illimitee", ok: true },
    { t: "Import Factur-X", ok: true },
    { t: "E-reporting automatique", ok: true },
    { t: "Suivi des statuts PA en temps reel", ok: true },
    { t: "Creation de factures et devis", ok: false },
  ]},
  { name: "Pro", price: "59", popular: false, features: [
    { t: "Tout le Standard", ok: true },
    { t: "Creation factures, devis et avoirs", ok: true },
    { t: "5 modeles de facture personnalisables", ok: true },
