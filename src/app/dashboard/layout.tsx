...
function isNavItem(item: string | NavItem): item is NavItem {
...
function SidebarContent({ onNavigate }: { onNavigate?: () => void }) {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 mx-3 mb-2 rounded-lg bg-violet-50">
        <p className="text-xs font-medium text-violet-800">
          Vous êtes en règle
        </p>
        <p className="text-xs text-violet-600 mt-0.5">
          Facturation conforme à la réforme 2026
        </p>
      </div>
      ...
      <div className="px-3 mb-4">
        <button
          ...
          className="flex items-center gap-2 text-sm text-gray-500 hover:text-red-500 transition-colors px-3 py-2 rounded-lg hover:bg-red-50 w-full"
        >
